...
print("=" * 70)
print("TEST 6 (CORRECTED): T_bath Sweep with Prominence-Based Peak Detection")
print("=" * 70)
...
# CORRECTED: Use prominence instead of fixed height
# This filters out noise-induced bumps that don't represent real oscillations
...
for T_bath in T_bath_values:
    ...
    for trial in range(N_TRIALS):
        ...
        # CORRECTED: Use prominence instead of height
...
ax.set_title(f"Escape Statistics vs Noise Strength (g={g_fixed}) - Prominence-Based Detection", fontsize=14)
ax.legend(fontsize=10)
ax.grid(True, which="both", ls="--", alpha=0.5)
plt.tight_layout()
plt.savefig("sfit_tbath_sweep_prominence.png", dpi=300)
print("\nSaved: sfit_tbath_sweep_prominence.png")
...
if len(valid) >= 3:
    ...
    plt.tight_layout()
    plt.savefig("sfit_arrhenius_check_prominence.png", dpi=300)
    print("Saved: sfit_arrhenius_check_prominence.png")
else:
